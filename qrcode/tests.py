...
class MainViewTest(TestCase):
    ...
    def test_edit(self):
        ...
        self.assertEqual(self.client.get("/code/edit/1/").status_code, 200)
        data = {"title": "title2", "text": "text2", "submit": True}
        self.assertRedirects(
            self.client.post("/code/edit/1/", data=data),
            "/account/home/edit/",
            302,
        )
    ...
    def test_delete(self):
        ...
        self.assertEqual(self.client.get("/code/delete/1/").status_code, 404)
        data = {"title": "title", "text": "text"}
        self.assertRedirects(
            self.client.post("/code/add/", data=data), "/code/add/", 302
        )
        self.assertRedirects(
            self.client.post("/code/delete/1/", data={"delete": True}),
            "/account/home/edit/",
            302,
        )
